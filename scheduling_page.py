...
def show_scheduling_page(filtered_data):
    ...
    with st.container(border=True):
        ...
        with left:
            st.caption("Average attendance per day of the week to help choose the best day for services or events.")
        ...
        with right:
            st.caption("Which service time usually attracts the highest attendance.")
